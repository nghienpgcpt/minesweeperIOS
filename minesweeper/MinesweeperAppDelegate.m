...
@interface MinesweeperAppDelegate ()
...
- (void)populateDefaultStore {
	...
	Options *option = [NSEntityDescription insertNewObjectForEntityForName:@"Options" inManagedObjectContext:self.managedObjectContext];
	option.level = [NSNumber numberWithInt:1];
	option.size = [NSNumber numberWithInt:1];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"MinesweeperModel" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"MinesweeperModel.sqlite"];
